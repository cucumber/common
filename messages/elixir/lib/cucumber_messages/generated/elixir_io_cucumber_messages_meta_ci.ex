...
defmodule(Io.Cucumber.Messages.Meta.CI) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.Meta.CI))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {3, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Meta.CI.Git.decode!(delimited)
    ...
    def(defs()) do
      %{
        ...
        3 => {:git, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.CI.Git}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        git: {3, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.CI.Git}},
