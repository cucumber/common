...
defmodule(Io.Cucumber.Messages.TestCaseFinished) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.TestCaseFinished))
        end
      )
    ...
    def(defs()) do
      %{
        1 => {:timestamp, {:default, nil}, {:message, Io.Cucumber.Messages.Timestamp}},
    ...
    def(defs_by_name()) do
      %{
        ...
        timestamp: {1, {:default, nil}, {:message, Io.Cucumber.Messages.Timestamp}}
      }
    end
