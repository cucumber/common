...
defmodule(CucumberMessages.Io.Cucumber.Messages.PickleStepArgument.PickleDocString) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(CucumberMessages.Io.Cucumber.Messages.PickleStepArgument.PickleDocString)
          )
        end
      )
