...
defmodule(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Background) do
  @moduledoc false
  (
    defstruct(
      location: nil,
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Background)
          )
        end
      )
