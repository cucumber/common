...
defmodule(CucumberMessages.Io.Cucumber.Messages.PickleStepArgument) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(CucumberMessages.Io.Cucumber.Messages.PickleStepArgument))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.PickleStepArgument.PickleDocString.decode!(
                    delimited
                  )
              ...
              {2, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.PickleStepArgument.PickleTable.decode!(
                    delimited
                  )
      ...
      %{
        1 =>
          {:doc_string, {:oneof, :message},
           {:message, CucumberMessages.Io.Cucumber.Messages.PickleStepArgument.PickleDocString}},
        2 =>
          {:data_table, {:oneof, :message},
           {:message, CucumberMessages.Io.Cucumber.Messages.PickleStepArgument.PickleTable}}
      }
    end
