...
defmodule(Io.Cucumber.Messages.Attachment) do
  @moduledoc false
  (
    defstruct(
      source: nil,
        ...
        defp(encode_content_encoding(acc, msg)) do
          ...
          if(field_value == :IDENTITY) do
            ...
            [
              ...
              "0",
              field_value
              |> Io.Cucumber.Messages.Attachment.ContentEncoding.encode()
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.Attachment))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                value = Io.Cucumber.Messages.SourceReference.decode!(delimited)
              ...
              {6, _, bytes} ->
                {value, rest} =
                  Protox.Decode.parse_enum(bytes, Io.Cucumber.Messages.Attachment.ContentEncoding)
    ...
    def(defs()) do
      %{
        1 => {:source, {:default, nil}, {:message, Io.Cucumber.Messages.SourceReference}},
        ...
        6 =>
          {:content_encoding, {:default, :IDENTITY},
           {:enum, Io.Cucumber.Messages.Attachment.ContentEncoding}},
    ...
    def(defs_by_name()) do
      %{
        ...
        content_encoding:
          {6, {:default, :IDENTITY}, {:enum, Io.Cucumber.Messages.Attachment.ContentEncoding}},
        file_name: {7, {:default, ""}, :string},
        media_type: {5, {:default, ""}, :string},
        source: {1, {:default, nil}, {:message, Io.Cucumber.Messages.SourceReference}},
