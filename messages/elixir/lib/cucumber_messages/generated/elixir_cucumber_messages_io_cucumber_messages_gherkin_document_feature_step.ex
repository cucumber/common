...
defmodule(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step)
          )
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {4, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step.DocString.decode!(
                    delimited
                  )
              ...
              {5, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step.DataTable.decode!(
                    delimited
                  )
      ...
      %{
        ...
        4 =>
          {:doc_string, {:oneof, :argument},
           {:message,
            CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step.DocString}},
        5 =>
          {:data_table, {:oneof, :argument},
           {:message,
            CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step.DataTable}},
        6 => {:id, {:default, ""}, :string}
      }
    end
