...
defmodule(Io.Cucumber.Messages.Pickle) do
  @moduledoc false
  (
    defstruct(
      id: "",
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.Pickle))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Pickle.PickleStep.decode!(delimited)
              ...
              {6, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Pickle.PickleTag.decode!(delimited)
    ...
    def(defs()) do
      %{
        ...
        5 => {:steps, :unpacked, {:message, Io.Cucumber.Messages.Pickle.PickleStep}},
        6 => {:tags, :unpacked, {:message, Io.Cucumber.Messages.Pickle.PickleTag}},
    ...
    def(defs_by_name()) do
      %{
        ...
        steps: {5, :unpacked, {:message, Io.Cucumber.Messages.Pickle.PickleStep}},
        tags: {6, :unpacked, {:message, Io.Cucumber.Messages.Pickle.PickleTag}},
