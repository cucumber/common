...
defmodule(CucumberMessages.Io.Cucumber.Messages.TestCase.TestStep) do
  @moduledoc false
  (
    defstruct(
      id: "",
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(CucumberMessages.Io.Cucumber.Messages.TestCase.TestStep))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {4, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList.decode!(
                    delimited
                  )
      ...
      %{
        ...
        4 =>
          {:step_match_arguments_lists, :unpacked,
           {:message,
            CucumberMessages.Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList}},
