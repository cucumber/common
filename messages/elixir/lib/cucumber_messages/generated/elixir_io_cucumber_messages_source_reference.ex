...
defmodule(Io.Cucumber.Messages.SourceReference) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.SourceReference))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {3, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.SourceReference.JavaMethod.decode!(delimited)
              ...
              {4, _, bytes} ->
                ...
                value =
                  Io.Cucumber.Messages.SourceReference.JavaStackTraceElement.decode!(delimited)
    ...
    def(defs()) do
      %{
        ...
        2 => {:location, {:default, nil}, {:message, Io.Cucumber.Messages.Location}},
        3 =>
          {:java_method, {:oneof, :reference},
           {:message, Io.Cucumber.Messages.SourceReference.JavaMethod}},
        4 =>
          {:java_stack_trace_element, {:oneof, :reference},
           {:message, Io.Cucumber.Messages.SourceReference.JavaStackTraceElement}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        java_method:
          {3, {:oneof, :reference}, {:message, Io.Cucumber.Messages.SourceReference.JavaMethod}},
        java_stack_trace_element:
          {4, {:oneof, :reference},
           {:message, Io.Cucumber.Messages.SourceReference.JavaStackTraceElement}},
        location: {2, {:default, nil}, {:message, Io.Cucumber.Messages.Location}},
