...
defmodule(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Scenario) do
  @moduledoc false
  (
    defstruct(
      location: nil,
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Scenario)
          )
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {6, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step.decode!(
                    delimited
                  )
              ...
              {7, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Scenario.Examples.decode!(
                    delimited
                  )
    ...
    def(defs()) do
      %{
        ...
        6 =>
          {:steps, :unpacked,
           {:message, CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step}},
        7 =>
          {:examples, :unpacked,
           {:message,
