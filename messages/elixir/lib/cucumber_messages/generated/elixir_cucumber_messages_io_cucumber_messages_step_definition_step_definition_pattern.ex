...
defmodule(CucumberMessages.Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern) do
  @moduledoc false
  (
        ...
        defp(encode_type(acc, msg)) do
          ...
          if(field_value == :CUCUMBER_EXPRESSION) do
            ...
            [
              ...
              <<16>>,
              field_value
              |> CucumberMessages.Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern.StepDefinitionPatternType.encode()
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(CucumberMessages.Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern)
          )
        end
      )
              ...
              {2, _, bytes} ->
                {value, rest} =
                  Protox.Decode.parse_enum(
                    bytes,
                    CucumberMessages.Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern.StepDefinitionPatternType
                  )
