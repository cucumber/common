...
defmodule(CucumberMessages.Io.Cucumber.Messages.StepDefinition) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(CucumberMessages.Io.Cucumber.Messages.StepDefinition))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern.decode!(
                    delimited
                  )
    ...
    def(defs()) do
      %{
        ...
        2 =>
          {:pattern, {:default, nil},
           {:message, CucumberMessages.Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern}},
        3 =>
          {:source_reference, {:default, nil},
      ...
      %{
        ...
        pattern:
          {2, {:default, nil},
           {:message, CucumberMessages.Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern}},
        source_reference:
          {3, {:default, nil}, {:message, CucumberMessages.Io.Cucumber.Messages.SourceReference}}
      }
    end
