...
defmodule(Io.Cucumber.Messages.Meta) do
  @moduledoc false
  (
    defstruct(
      protocol_version: "",
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.Meta))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Meta.Product.decode!(delimited)
              ...
              {6, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Meta.CI.decode!(delimited)
    ...
    def(defs()) do
      %{
        ...
        2 => {:implementation, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.Product}},
        3 => {:runtime, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.Product}},
        4 => {:os, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.Product}},
        5 => {:cpu, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.Product}},
        6 => {:ci, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.CI}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ci: {6, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.CI}},
        cpu: {5, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.Product}},
        implementation: {2, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.Product}},
        os: {4, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.Product}},
        protocol_version: {1, {:default, ""}, :string},
        runtime: {3, {:default, nil}, {:message, Io.Cucumber.Messages.Meta.Product}}
      }
    end
