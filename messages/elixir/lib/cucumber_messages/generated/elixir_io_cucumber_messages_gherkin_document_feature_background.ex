...
defmodule(Io.Cucumber.Messages.GherkinDocument.Feature.Background) do
  @moduledoc false
  (
    defstruct(
      location: nil,
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.GherkinDocument.Feature.Background))
        end
      )
    ...
    def(defs()) do
      %{
        ...
        5 => {:steps, :unpacked, {:message, Io.Cucumber.Messages.GherkinDocument.Feature.Step}},
        6 => {:id, {:default, ""}, :string}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        steps: {5, :unpacked, {:message, Io.Cucumber.Messages.GherkinDocument.Feature.Step}}
      }
    end
