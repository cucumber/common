...
defmodule(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.TableRow) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.TableRow)
          )
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.TableRow.TableCell.decode!(
                    delimited
                  )
    ...
    def(defs()) do
      %{
        ...
        2 =>
          {:cells, :unpacked,
           {:message,
            CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.TableRow.TableCell}},
        3 => {:id, {:default, ""}, :string}
      }
    end
        ...
        cells:
          {2, :unpacked,
           {:message,
            CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.TableRow.TableCell}},
        id: {3, {:default, ""}, :string},
        location: {1, {:default, nil}, {:message, CucumberMessages.Io.Cucumber.Messages.Location}}
      }
    end
