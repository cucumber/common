...
defmodule(CucumberMessages.Io.Cucumber.Messages.Pickle.PickleTag) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(CucumberMessages.Io.Cucumber.Messages.Pickle.PickleTag))
        end
      )
