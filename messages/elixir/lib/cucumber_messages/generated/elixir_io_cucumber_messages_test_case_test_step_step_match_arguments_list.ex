...
defmodule(Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList)
          )
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                value =
                  Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList.StepMatchArgument.decode!(
                    delimited
                  )
      ...
      %{
        1 =>
          {:step_match_arguments, :unpacked,
           {:message,
            Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList.StepMatchArgument}}
      }
    end
