...
defmodule(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature) do
  @moduledoc false
  (
    defstruct(
      location: nil,
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature)
          )
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {7, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.decode!(
                    delimited
                  )
    ...
    def(defs()) do
      %{
        ...
        7 =>
          {:children, :unpacked,
           {:message, CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild}}
      }
    end
