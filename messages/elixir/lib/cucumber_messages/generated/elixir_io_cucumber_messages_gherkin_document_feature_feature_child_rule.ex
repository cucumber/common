...
defmodule(Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.Rule) do
  @moduledoc false
  (
    defstruct(
      location: nil,
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.Rule)
          )
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                ...
                value =
                  Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.RuleChild.decode!(
                    delimited
                  )
