          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList.StepMatchArgument.Group.decode!(
                    delimited
                  )
    ...
    def(defs()) do
      %{
        ...
        2 =>
          {:group, {:default, nil},
           {:message,
            CucumberMessages.Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList.StepMatchArgument.Group}}
      }
    end
