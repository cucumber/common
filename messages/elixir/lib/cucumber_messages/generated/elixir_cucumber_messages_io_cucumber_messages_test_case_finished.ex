...
defmodule(CucumberMessages.Io.Cucumber.Messages.TestCaseFinished) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(CucumberMessages.Io.Cucumber.Messages.TestCaseFinished))
        end
      )
    ...
    def(defs_by_name()) do
      %{
        ...
        timestamp:
          {1, {:default, nil}, {:message, CucumberMessages.Io.Cucumber.Messages.Timestamp}}
      }
    end
