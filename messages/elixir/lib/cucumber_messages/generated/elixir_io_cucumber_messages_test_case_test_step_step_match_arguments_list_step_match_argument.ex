...
defmodule(Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList.StepMatchArgument) do
  @moduledoc false
  (
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                value =
                  Io.Cucumber.Messages.TestCase.TestStep.StepMatchArgumentsList.StepMatchArgument.Group.decode!(
                    delimited
                  )
