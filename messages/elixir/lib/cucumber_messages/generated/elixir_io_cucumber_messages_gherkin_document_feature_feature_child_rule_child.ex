...
defmodule(Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.RuleChild) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.RuleChild)
          )
        end
      )
      ...
      %{
        background:
          {1, {:oneof, :value},
           {:message, Io.Cucumber.Messages.GherkinDocument.Feature.Background}},
        scenario:
          {2, {:oneof, :value}, {:message, Io.Cucumber.Messages.GherkinDocument.Feature.Scenario}}
      }
    end
