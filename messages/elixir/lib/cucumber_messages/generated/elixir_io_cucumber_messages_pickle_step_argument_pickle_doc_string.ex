...
defmodule(Io.Cucumber.Messages.PickleStepArgument.PickleDocString) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.PickleStepArgument.PickleDocString))
        end
      )
