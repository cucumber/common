...
defmodule(Io.Cucumber.Messages.Envelope) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.Envelope))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                value = Io.Cucumber.Messages.Source.decode!(delimited)
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.GherkinDocument.decode!(delimited)
              ...
              {3, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Pickle.decode!(delimited)
              ...
              {4, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.StepDefinition.decode!(delimited)
              ...
              {5, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Hook.decode!(delimited)
              ...
              {6, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.ParameterType.decode!(delimited)
              ...
              {7, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.TestCase.decode!(delimited)
              ...
              {8, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.UndefinedParameterType.decode!(delimited)
              ...
              {9, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.TestRunStarted.decode!(delimited)
              ...
              {10, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.TestCaseStarted.decode!(delimited)
              ...
              {11, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.TestStepStarted.decode!(delimited)
              ...
              {12, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Attachment.decode!(delimited)
              ...
              {13, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.TestStepFinished.decode!(delimited)
              ...
              {14, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.TestCaseFinished.decode!(delimited)
              ...
              {15, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.TestRunFinished.decode!(delimited)
              ...
              {16, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.ParseError.decode!(delimited)
              ...
              {17, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                <<delimited::binary-size(len), rest::binary>> = bytes
                value = Io.Cucumber.Messages.Meta.decode!(delimited)
    ...
    def(defs()) do
      %{
        1 => {:source, {:oneof, :message}, {:message, Io.Cucumber.Messages.Source}},
        2 =>
          {:gherkin_document, {:oneof, :message},
           {:message, Io.Cucumber.Messages.GherkinDocument}},
        3 => {:pickle, {:oneof, :message}, {:message, Io.Cucumber.Messages.Pickle}},
        4 =>
          {:step_definition, {:oneof, :message}, {:message, Io.Cucumber.Messages.StepDefinition}},
        5 => {:hook, {:oneof, :message}, {:message, Io.Cucumber.Messages.Hook}},
        6 =>
          {:parameter_type, {:oneof, :message}, {:message, Io.Cucumber.Messages.ParameterType}},
        7 => {:test_case, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestCase}},
        8 =>
          {:undefined_parameter_type, {:oneof, :message},
           {:message, Io.Cucumber.Messages.UndefinedParameterType}},
        9 =>
          {:test_run_started, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestRunStarted}},
        10 =>
        ...
        12 => {:attachment, {:oneof, :message}, {:message, Io.Cucumber.Messages.Attachment}},
        13 =>
        ...
        16 => {:parse_error, {:oneof, :message}, {:message, Io.Cucumber.Messages.ParseError}},
        17 => {:meta, {:oneof, :message}, {:message, Io.Cucumber.Messages.Meta}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        attachment: {12, {:oneof, :message}, {:message, Io.Cucumber.Messages.Attachment}},
        gherkin_document:
          {2, {:oneof, :message}, {:message, Io.Cucumber.Messages.GherkinDocument}},
        hook: {5, {:oneof, :message}, {:message, Io.Cucumber.Messages.Hook}},
        meta: {17, {:oneof, :message}, {:message, Io.Cucumber.Messages.Meta}},
        parameter_type: {6, {:oneof, :message}, {:message, Io.Cucumber.Messages.ParameterType}},
        parse_error: {16, {:oneof, :message}, {:message, Io.Cucumber.Messages.ParseError}},
        pickle: {3, {:oneof, :message}, {:message, Io.Cucumber.Messages.Pickle}},
        source: {1, {:oneof, :message}, {:message, Io.Cucumber.Messages.Source}},
        step_definition: {4, {:oneof, :message}, {:message, Io.Cucumber.Messages.StepDefinition}},
        test_case: {7, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestCase}},
        test_case_finished:
          {14, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestCaseFinished}},
        test_case_started:
          {10, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestCaseStarted}},
        test_run_finished:
          {15, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestRunFinished}},
        test_run_started:
          {9, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestRunStarted}},
        test_step_finished:
          {13, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestStepFinished}},
        test_step_started:
          {11, {:oneof, :message}, {:message, Io.Cucumber.Messages.TestStepStarted}},
        undefined_parameter_type:
          {8, {:oneof, :message}, {:message, Io.Cucumber.Messages.UndefinedParameterType}}
      }
    end
