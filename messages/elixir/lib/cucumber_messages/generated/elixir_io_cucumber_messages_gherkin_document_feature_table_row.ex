...
defmodule(Io.Cucumber.Messages.GherkinDocument.Feature.TableRow) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.GherkinDocument.Feature.TableRow))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                value =
                  Io.Cucumber.Messages.GherkinDocument.Feature.TableRow.TableCell.decode!(
                    delimited
                  )
