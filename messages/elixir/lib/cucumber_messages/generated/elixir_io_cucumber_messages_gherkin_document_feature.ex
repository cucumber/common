...
defmodule(Io.Cucumber.Messages.GherkinDocument.Feature) do
  @moduledoc false
  (
    defstruct(
      location: nil,
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.GherkinDocument.Feature))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {7, _, bytes} ->
                ...
                value =
                  Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.decode!(delimited)
    ...
    def(defs_by_name()) do
      %{
        children:
          {7, :unpacked, {:message, Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild}},
