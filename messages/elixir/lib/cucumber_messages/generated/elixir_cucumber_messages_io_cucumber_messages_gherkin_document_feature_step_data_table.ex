...
defmodule(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step.DataTable) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.Step.DataTable)
          )
        end
      )
