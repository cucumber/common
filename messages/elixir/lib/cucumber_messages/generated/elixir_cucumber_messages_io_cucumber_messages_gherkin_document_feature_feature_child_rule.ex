...
defmodule(CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.Rule) do
  @moduledoc false
  (
    defstruct(
      location: nil,
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.GherkinDocument.Feature.FeatureChild.RuleChild.decode!(
                    delimited
                  )
