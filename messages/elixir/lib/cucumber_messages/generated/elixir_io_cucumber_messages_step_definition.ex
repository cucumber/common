...
defmodule(Io.Cucumber.Messages.StepDefinition) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(Io.Cucumber.Messages.StepDefinition))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                value =
                  Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern.decode!(delimited)
    ...
    def(defs()) do
      %{
        ...
        2 =>
          {:pattern, {:default, nil},
           {:message, Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern}},
        3 =>
          {:source_reference, {:default, nil}, {:message, Io.Cucumber.Messages.SourceReference}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        pattern:
          {2, {:default, nil},
           {:message, Io.Cucumber.Messages.StepDefinition.StepDefinitionPattern}},
        source_reference: {3, {:default, nil}, {:message, Io.Cucumber.Messages.SourceReference}}
      }
    end
