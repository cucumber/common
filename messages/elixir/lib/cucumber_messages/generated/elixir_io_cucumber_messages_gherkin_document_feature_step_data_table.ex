...
defmodule(Io.Cucumber.Messages.GherkinDocument.Feature.Step.DataTable) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(
            bytes,
            struct(Io.Cucumber.Messages.GherkinDocument.Feature.Step.DataTable)
          )
        end
      )
    ...
    def(defs()) do
      %{
        ...
        2 => {:rows, :unpacked, {:message, Io.Cucumber.Messages.GherkinDocument.Feature.TableRow}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        rows: {2, :unpacked, {:message, Io.Cucumber.Messages.GherkinDocument.Feature.TableRow}}
      }
    end
