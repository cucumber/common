...
defmodule(CucumberMessages.Io.Cucumber.Messages.Pickle.PickleStep) do
  @moduledoc false
  (
    ...
    (
      ...
      (
        ...
        def(decode!(bytes)) do
          parse_key_value(bytes, struct(CucumberMessages.Io.Cucumber.Messages.Pickle.PickleStep))
        end
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                value =
                  CucumberMessages.Io.Cucumber.Messages.PickleStepArgument.decode!(delimited)
      ...
      %{
        ...
        2 =>
          {:argument, {:default, nil},
           {:message, CucumberMessages.Io.Cucumber.Messages.PickleStepArgument}},
        3 => {:id, {:default, ""}, :string},
