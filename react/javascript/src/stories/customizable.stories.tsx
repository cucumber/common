...
import Attachments, {IAttachmentsProps} from '../components/gherkin/Attachments';
import {FilteredResults, QueriesWrapper} from '../index';
import queries from "./queries";

// 64x64 #ff0000 png from https://png-pixel.com/
const pngBase64 = 'iVBORw0KGgoAAAANSUhEUgAAAEAAAABACAYAAACqaXHeAAAAY0lEQVR42u3QAREAAAQEsJdcdHI4W4TVJJ3HSoAAAQIECBAgQIAAAQIECBAgQIAAAQIECBAgQIAAAQIECBAgQIAAAQIECBAgQIAAAQIECBAgQIAAAQIECBAgQIAAAQIECLhvAUBsX8GVkqJPAAAAAElFTkSuQmCC'
...
export const MultipleOverrides = () => <QueriesWrapper {...queries(attachments)}
...
export const NoOverrideAttachments = () => <MessageToComponentMappingContext.Provider value={{}}>
  <CustomizableAttachments attachments={[textAttachment, imageAttachment]} />
</MessageToComponentMappingContext.Provider>

export const OverrideAttachments = () => <MessageToComponentMappingContext.Provider value={{attachments: CountAttachments}}>
  <CustomizableAttachments attachments={[textAttachment, imageAttachment]} />
</MessageToComponentMappingContext.Provider>

export const NoOverrideAttachment = () => <MessageToComponentMappingContext.Provider value={{}}>
  <CustomizableAttachment attachment={textAttachment} />
</MessageToComponentMappingContext.Provider>

export const OverrideAttachment = () => <MessageToComponentMappingContext.Provider value={{attachment: CapitalizedAttachment}}>
  <CustomizableAttachment attachment={textAttachment} />
</MessageToComponentMappingContext.Provider>

export const NoOverrideImageAttachment = () => <MessageToComponentMappingContext.Provider value={{}}>
  <CustomizableImageAttachment attachment={imageAttachment} />
</MessageToComponentMappingContext.Provider>

export const OverrideImageAttachment = () => <MessageToComponentMappingContext.Provider value={{imageAttachment: ThumbnailImageAttachment}}>
  <CustomizableImageAttachment attachment={imageAttachment} />
</MessageToComponentMappingContext.Provider>
