...
//        Config config = new Config();
//        config.set("some.stringlist", new PropertyList());
//        config.set("some.stringlist", new Property("one", null));
//        config.set("some.stringlist", new Property("two", null));
//        Value l = config.get("some.stringlist");
