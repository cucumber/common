    ...
    convertNode(node, parent) {
        ...
        switch (node.kind) {
            ...
            case SyntaxKind.PostfixUnaryExpression: {
                const operator = (_h = node_utils_1.getTextForTokenKind(node.operator), (_h !== null && _h !== void 0 ? _h : ''));
                /**
            ...
            case SyntaxKind.InterfaceDeclaration: {
                const interfaceHeritageClauses = (_j = node.heritageClauses, (_j !== null && _j !== void 0 ? _j : []));
                const result = this.createNode(node, {
