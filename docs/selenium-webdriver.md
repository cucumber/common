...
Let us see an example how cucumber can fit into selenium-webdriver in UI testing, by converting [Selenium-Web driver by example.](http://docs.seleniumhq.org/docs/03_webdriver.jsp#introducing-the-selenium-webdriver-api-by-example "Selenium-Webdriver by Example tutorial")
