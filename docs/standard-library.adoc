...
[Technical Committee](../CONTRIBUTING.md#vocabulary) of each Cucumber implementation
will decide on the migration path.

[Contributors](../CONTRIBUTING.md#vocabulary) are encouraged to send pull request
against the [cucumber/cucumber](https://github.com/cucumber/cucumber) repository
