...
function (_Component) {
  ...
  function ShortcutsScreen(props) {
    ...
    _this.saveShortcut = function _callee2() {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return regeneratorRuntime.awrap(setShortcut(activeFeature, shortcutKeys[activeFeature].shortcut));
    ...
    _this.restoreDefaults = function _callee3() {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return regeneratorRuntime.awrap(restoreAllDefaultShortcuts());
    ...
    _this.restoreDefault = function _callee4() {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 4;
              return regeneratorRuntime.awrap(restoreDefaultShortcut(activeFeature));
    ...
    _this.renderKeyInput = function () {
      var shortcutKeys = _this.state.shortcutKeys;
      var arr = Object.entries(shortcutKeys).map(function (_ref11) {
        var _ref12 = _slicedToArray(_ref11, 2),
            feature = _ref12[0],
            shortcut = _ref12[1].shortcut;
    ...
    _this.renderKeyForm = function () {
      return _react["default"].createElement(GridWrapper, null, _ref13, _this.renderKeyInput());
    };
  ...
  _createClass(ShortcutsScreen, [{
    ...
    value: function render() {
      ...
      }, _react["default"].createElement(Container, null, _ref15, layout, _react["default"].createElement(Button, {
        tertiary: true,
        small: true,
        id: "restoreDefaultsHotkeys",
        onClick: this.restoreDefaults
      }, "Restore defaults"), _ref16))));
    }
  }]);
