...
<html lang="en">
<head>
    <title>Code coverage report for lib/properties/borderStyle.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/properties</a> borderStyle.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >  return typeof v === 'string' &amp;&amp; (v === '' || styles.indexOf(v) !== -1);</span>
};
...
<span class="cstat-no" title="statement not covered" >    return this.getPropertyValue('border-style');</span>
  },
  enumerable: true,
  configurable: true,
};
