...
```elixir
# For the tokenizer
iex> Gherkin.tokenize("testdata/good/background.feature") |> IO.puts
...
Gherkin.parse_path("testdata/good/background.feature", [:no_ast, :no_pickles])
[
...
Gherkin.parse_path("testdata/good/background.feature", [:no_ast, :no_source])
[
  %CucumberMessages.Envelope{
    __uf__: [],
    message: {:pickle,
...
# Or the AST
Gherkin.parse_path("testdata/good/background.feature", [:no_pickles, :no_source])
[
  %CucumberMessages.Envelope{
    __uf__: [],
...
```elixir
Gherkin.parse_path("testdata/good/background.feature", []) |> Gherkin.print_messages(:ndjson) |> IO.puts
{"source":{"data": .......... }}
