...
class Parser<T extends INullSafetyObject>
{
  ...
  V _handleExternalError<V>(ParserContext context, V Function() action, V defaultValue) {
    if (stopAtFirstError) {
      return action();
    }
  ...
  {
    return _handleExternalError(context, () => context.tokenMatcher.match_EOF(token), false);
  }
  ...
  bool match_Empty(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_Empty(token), false);
  }
  ...
  bool match_Comment(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_Comment(token), false);
  }
  ...
  bool match_TagLine(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_TagLine(token), false);
  }
  ...
  bool match_FeatureLine(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_FeatureLine(token), false);
  }
  ...
  bool match_RuleLine(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_RuleLine(token), false);
  }
  ...
  bool match_BackgroundLine(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_BackgroundLine(token), false);
  }
  ...
  bool match_ScenarioLine(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_ScenarioLine(token), false);
  }
  ...
  bool match_ExamplesLine(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_ExamplesLine(token), false);
  }
  ...
  bool match_StepLine(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_StepLine(token), false);
  }
  ...
  bool match_DocStringSeparator(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_DocStringSeparator(token), false);
  }
  ...
  bool match_TableRow(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_TableRow(token), false);
  }
  ...
  bool match_Language(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_Language(token), false);
  }
  ...
  bool match_Other(ParserContext context, Token token)
  {
    ...
    return _handleExternalError(context, () => context.tokenMatcher.match_Other(token), false);
  }
  ...
  int matchTokenAt_22(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 22 - GherkinDocument:0>Feature:3>Rule:0>RuleHeader:0>#RuleLine:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Empty', '#Comment', '#BackgroundLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_23(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 23 - GherkinDocument:0>Feature:3>Rule:0>RuleHeader:1>DescriptionHelper:1>Description:0>#Other:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Comment', '#BackgroundLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_24(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 24 - GherkinDocument:0>Feature:3>Rule:0>RuleHeader:1>DescriptionHelper:2>#Comment:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Comment', '#BackgroundLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_25(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 25 - GherkinDocument:0>Feature:3>Rule:1>Background:0>#BackgroundLine:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Empty', '#Comment', '#StepLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_26(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 26 - GherkinDocument:0>Feature:3>Rule:1>Background:1>DescriptionHelper:1>Description:0>#Other:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Comment', '#StepLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_27(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 27 - GherkinDocument:0>Feature:3>Rule:1>Background:1>DescriptionHelper:2>#Comment:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Comment', '#StepLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_28(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 28 - GherkinDocument:0>Feature:3>Rule:1>Background:2>Step:0>#StepLine:0';
    token.detach();
    var expectedTokens = ['#EOF', '#TableRow', '#DocStringSeparator', '#StepLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_29(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 29 - GherkinDocument:0>Feature:3>Rule:1>Background:2>Step:1>StepArg:0>__alt0:0>DataTable:0>#TableRow:0';
    token.detach();
    var expectedTokens = ['#EOF', '#TableRow', '#StepLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_30(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 30 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:0>Tags:0>#TagLine:0';
    token.detach();
    var expectedTokens = ['#TagLine', '#ScenarioLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_31(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 31 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:0>#ScenarioLine:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Empty', '#Comment', '#StepLine', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_32(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 32 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:1>DescriptionHelper:1>Description:0>#Other:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Comment', '#StepLine', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_33(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 33 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:1>DescriptionHelper:2>#Comment:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Comment', '#StepLine', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_34(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 34 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:2>Step:0>#StepLine:0';
    token.detach();
    var expectedTokens = ['#EOF', '#TableRow', '#DocStringSeparator', '#StepLine', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_35(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 35 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:2>Step:1>StepArg:0>__alt0:0>DataTable:0>#TableRow:0';
    token.detach();
    var expectedTokens = ['#EOF', '#TableRow', '#StepLine', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_36(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 36 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:3>ExamplesDefinition:0>Tags:0>#TagLine:0';
    token.detach();
    var expectedTokens = ['#TagLine', '#ExamplesLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_37(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 37 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:3>ExamplesDefinition:1>Examples:0>#ExamplesLine:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Empty', '#Comment', '#TableRow', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_38(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 38 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:3>ExamplesDefinition:1>Examples:1>DescriptionHelper:1>Description:0>#Other:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Comment', '#TableRow', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_39(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 39 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:3>ExamplesDefinition:1>Examples:1>DescriptionHelper:2>#Comment:0';
    token.detach();
    var expectedTokens = ['#EOF', '#Comment', '#TableRow', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_40(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 40 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:3>ExamplesDefinition:1>Examples:2>ExamplesTable:0>#TableRow:0';
    token.detach();
    var expectedTokens = ['#EOF', '#TableRow', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_42(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 42 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:2>Step:1>StepArg:0>__alt0:1>DocString:0>#DocStringSeparator:0';
    token.detach();
  ...
  int matchTokenAt_43(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 43 - GherkinDocument:0>Feature:3>Rule:2>ScenarioDefinition:1>Scenario:2>Step:1>StepArg:0>__alt0:1>DocString:2>#DocStringSeparator:0';
    token.detach();
  ...
  int matchTokenAt_45(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 45 - GherkinDocument:0>Feature:3>Rule:1>Background:2>Step:1>StepArg:0>__alt0:1>DocString:2>#DocStringSeparator:0';
    token.detach();
  ...
  int matchTokenAt_46(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 46 - GherkinDocument:0>Feature:2>ScenarioDefinition:1>Scenario:2>Step:1>StepArg:0>__alt0:1>DocString:0>#DocStringSeparator:0';
    token.detach();
    var expectedTokens = ['#DocStringSeparator', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_47(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 47 - GherkinDocument:0>Feature:2>ScenarioDefinition:1>Scenario:2>Step:1>StepArg:0>__alt0:1>DocString:2>#DocStringSeparator:0';
    token.detach();
    var expectedTokens = ['#EOF', '#StepLine', '#TagLine', '#ExamplesLine', '#ScenarioLine', '#RuleLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_48(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 48 - GherkinDocument:0>Feature:1>Background:2>Step:1>StepArg:0>__alt0:1>DocString:0>#DocStringSeparator:0';
    token.detach();
    var expectedTokens = ['#DocStringSeparator', '#Other'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
  ...
  int matchTokenAt_49(Token token, ParserContext context)
  {
    ...
    final stateComment = 'State: 49 - GherkinDocument:0>Feature:1>Background:2>Step:1>StepArg:0>__alt0:1>DocString:2>#DocStringSeparator:0';
    token.detach();
    var expectedTokens = ['#EOF', '#StepLine', '#TagLine', '#ScenarioLine', '#RuleLine', '#Comment', '#Empty'];
    var error = token.isEof
        ? UnexpectedEofException(token, expectedTokens, stateComment)
