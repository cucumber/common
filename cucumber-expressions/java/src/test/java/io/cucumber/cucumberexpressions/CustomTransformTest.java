...
public class CustomTransformTest {
    ...
    public void transforms_CucumberExpression_arguments_with_expression_type() {
        Expression expression = new CucumberExpression("I have a {currency:currency} account", Collections.<Class<?>>emptyList(), transformLookup);
    ...
    public void transforms_CucumberExpression_arguments_with_explicit_type() {
        Expression expression = new CucumberExpression("I have a {currency} account", Collections.<Class<?>>singletonList(Currency.class), transformLookup);
        Object transformedArgumentValue = expression.match("I have a EUR account").get(0).getTransformedValue();
        assertEquals(Currency.getInstance("EUR"), transformedArgumentValue);
    }
    ...
    public void transforms_CucumberExpression_arguments_using_argument_name_as_type() {
        Expression expression = new CucumberExpression("I have a {currency} account", Collections.<Class<?>>emptyList(), transformLookup);
        Object transformedArgumentValue = expression.match("I have a EUR account").get(0).getTransformedValue();
        assertEquals(Currency.getInstance("EUR"), transformedArgumentValue);
    }
    ...
    public void transforms_CucumberExpression_arguments_with_explicit_type_using_constructor_directly() {
        Expression expression = new CucumberExpression("I have a {currency} account", Collections.<Class<?>>singletonList(CurrencyWithStringCtor.class), new TransformLookup(Locale.ENGLISH));
    ...
    public void transforms_RegularExpression_arguments_with_explicit_type() {
        Expression expression = new RegularExpression(compile("I have a ([A-Z]{3}) account"), Collections.<Class<?>>singletonList(Currency.class), transformLookup);
        Object transformedArgumentValue = expression.match("I have a EUR account").get(0).getTransformedValue();
        assertEquals(Currency.getInstance("EUR"), transformedArgumentValue);
    }
    ...
    public void transforms_RegularExpression_arguments_without_explicit_type() {
        Expression expression = new RegularExpression(compile("I have a ([A-Z]{3}) account"), Collections.<Class<?>>emptyList(), transformLookup);
        Object transformedArgumentValue = expression.match("I have a EUR account").get(0).getTransformedValue();
        assertEquals(Currency.getInstance("EUR"), transformedArgumentValue);
    }
    ...
    public void transforms_RegularExpression_arguments_with_explicit_type_using_constructor_directly() {
        Expression expression = new RegularExpression(compile("I have a ([A-Z]{3}) account"), Collections.<Class<?>>singletonList(CurrencyWithStringCtor.class), new TransformLookup(Locale.ENGLISH));
        CurrencyWithStringCtor transformedArgumentValue = (CurrencyWithStringCtor) expression.match("I have a EUR account").get(0).getTransformedValue();
        assertEquals("EUR", transformedArgumentValue.symbol);
    }
