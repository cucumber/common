...
var cucumber_expression_generator_1 = __importDefault(require("../src/cucumber_expression_generator"));
...
describe("CucumberExpressionGenerator", function () {
    ...
    function assertExpression(expectedExpression, expectedArgumentNames, text) {
        ...
        var cucumberExpression = new cucumber_expression_1.default(generatedExpression.source, parameterTypeRegistry);
    ...
    beforeEach(function () {
        ...
        generator = new cucumber_expression_generator_1.default(parameterTypeRegistry);
    });
    ...
    it("generates expression for custom type", function () {
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("currency", /[A-Z]{3}/, Currency, function (s) { return new Currency(s); }, true, false));
    ...
    it("prefers leftmost match when there is overlap", function () {
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("currency", /cd/, Currency, function (s) { return new Currency(s); }, true, false));
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("date", /bc/, Date, function (s) { return new Date(s); }, true, false));
    ...
    it("generates all combinations of expressions when several parameter types match", function () {
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("currency", /x/, null, function (s) { return new Currency(s); }, true, false));
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("date", /x/, null, function (s) { return new Date(s); }, true, false));
    ...
    it("matches parameter types with optional capture groups", function () {
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("optional-flight", /(1st flight)?/, null, function (s) { return s; }, true, false));
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("optional-hotel", /(1st hotel)?/, null, function (s) { return s; }, true, false));
    ...
    it("generates at most 256 expressions", function () {
        for (var i = 0; i < 4; i++) {
            parameterTypeRegistry.defineParameterType(new parameter_type_1.default("my-type-" + i, /[a-z]/, null, function (s) { return s; }, true, false));
        }
    ...
    it("prefers expression with longest non empty match", function () {
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("zero-or-more", /[a-z]*/, null, function (s) { return s; }, true, false));
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("exactly-one", /[a-z]/, null, function (s) { return s; }, true, false));
        var expressions = generator.generateExpressions("a simple step");
...
//# sourceMappingURL=cucumber_expression_generator_test.js.map