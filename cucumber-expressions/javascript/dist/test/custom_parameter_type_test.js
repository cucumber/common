...
var cucumber_expression_1 = __importDefault(require("../src/cucumber_expression"));
var regular_expression_1 = __importDefault(require("../src/regular_expression"));
...
describe("Custom parameter type", function () {
    ...
    beforeEach(function () {
        parameterTypeRegistry = new parameter_type_registry_1.default();
        /* eslint-disable prettier/prettier */
        /// [add-color-parameter-type]
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("color", // name
    ...
    describe("CucumberExpression", function () {
        it("throws exception for illegal character in parameter name", function () {
            assert_throws_1.default(function () { return new parameter_type_1.default("[string]", /.*/, String, function (s) { return s; }, false, true); }, "Illegal character '[' in parameter name {[string]}");
        });
        it("matches parameters with custom parameter type", function () {
            var expression = new cucumber_expression_1.default("I have a {color} ball", parameterTypeRegistry);
        ...
        it("matches parameters with multiple capture groups", function () {
            ...
            parameterTypeRegistry.defineParameterType(new parameter_type_1.default("coordinate", /(\d+),\s*(\d+),\s*(\d+)/, Coordinate, function (x, y, z) {
                return new Coordinate(Number(x), Number(y), Number(z));
            }, true, true));
            var expression = new cucumber_expression_1.default("A {int} thick line from {coordinate} to {coordinate}", parameterTypeRegistry);
        ...
        it("matches parameters with custom parameter type using optional capture group", function () {
            parameterTypeRegistry = new parameter_type_registry_1.default();
            parameterTypeRegistry.defineParameterType(new parameter_type_1.default("color", [/red|blue|yellow/, /(?:dark|light) (?:red|blue|yellow)/], Color, function (s) { return new Color(s); }, false, true));
            var expression = new cucumber_expression_1.default("I have a {color} ball", parameterTypeRegistry);
        ...
        it("defers transformation until queried from argument", function () {
            parameterTypeRegistry.defineParameterType(new parameter_type_1.default("throwing", /bad/, null, function (s) {
                throw new Error("Can't transform [" + s + "]");
            }, false, true));
            var expression = new cucumber_expression_1.default("I have a {throwing} parameter", parameterTypeRegistry);
        ...
        describe("conflicting parameter type", function () {
            it("is detected for type name", function () {
                assert_throws_1.default(function () {
                    return parameterTypeRegistry.defineParameterType(new parameter_type_1.default("color", /.*/, CssColor, function (s) { return new CssColor(s); }, false, true));
                }, "There is already a parameter type with name color");
            });
            it("is not detected for type", function () {
                parameterTypeRegistry.defineParameterType(new parameter_type_1.default("whatever", /.*/, Color, function (s) { return new Color(s); }, false, false));
            });
            it("is not detected for regexp", function () {
                parameterTypeRegistry.defineParameterType(new parameter_type_1.default("css-color", /red|blue|yellow/, CssColor, function (s) { return new CssColor(s); }, true, false));
                assert_1.default.strictEqual(new cucumber_expression_1.default("I have a {css-color} ball", parameterTypeRegistry)
                    .match("I have a blue ball")[0]
                    .getValue(null).constructor, CssColor);
                assert_1.default.strictEqual(new cucumber_expression_1.default("I have a {css-color} ball", parameterTypeRegistry)
                    .match("I have a blue ball")[0]
                    .getValue(null).name, "blue");
                assert_1.default.strictEqual(new cucumber_expression_1.default("I have a {color} ball", parameterTypeRegistry)
                    .match("I have a blue ball")[0]
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("asyncColor", /red|blue|yellow/, Color, function (s) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, new Color(s)];
                        }); }); }, false, true));
                        expression = new cucumber_expression_1.default("I have a {asyncColor} ball", parameterTypeRegistry);
    ...
    describe("RegularExpression", function () {
        it("matches arguments with custom parameter type", function () {
            var expression = new regular_expression_1.default(/I have a (red|blue|yellow) ball/, parameterTypeRegistry);
            var value = expression.match("I have a red ball")[0].getValue(null);
...
//# sourceMappingURL=custom_parameter_type_test.js.map