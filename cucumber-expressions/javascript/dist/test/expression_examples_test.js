...
describe("examples.txt", function () {
    ...
    var match = function (expressionText, text) {
        ...
        var expression = m
            ? new regular_expression_1.default(new RegExp(m[1]), new parameter_type_registry_1.default())
            : new cucumber_expression_1.default(expressionText, new parameter_type_registry_1.default());
...
//# sourceMappingURL=expression_examples_test.js.map