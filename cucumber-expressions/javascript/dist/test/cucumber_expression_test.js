...
describe("CucumberExpression", function () {
    ...
    it("documents match arguments", function () {
        var parameterTypeRegistry = new parameter_type_registry_1.default();
        /// [capture-match-arguments]
        var expr = "I have {int} cuke(s)";
        var expression = new cucumber_expression_1.default(expr, parameterTypeRegistry);
    ...
    it("exposes source", function () {
        var expr = "I have {int} cuke(s)";
        assert_1.default.strictEqual(new cucumber_expression_1.default(expr, new parameter_type_registry_1.default()).source, expr);
    });
    // JavaScript-specific
    it("delegates transform to custom object", function () {
        var parameterTypeRegistry = new parameter_type_registry_1.default();
        parameterTypeRegistry.defineParameterType(new parameter_type_1.default("widget", /\w+/, null, function (s) {
            return this.createWidget(s);
        }, false, true));
        var expression = new cucumber_expression_1.default("I have a {widget}", parameterTypeRegistry);
        var world = {
    ...
    describe("escapes special characters", function () {
        ["\\", "[", "]", "^", "$", ".", "|", "?", "*", "+"].forEach(function (character) {
            it("escapes " + character, function () {
                ...
                var expression = new cucumber_expression_1.default(expr, new parameter_type_registry_1.default());
...
var match = function (expression, text) {
    var cucumberExpression = new cucumber_expression_1.default(expression, new parameter_type_registry_1.default());
...
//# sourceMappingURL=cucumber_expression_test.js.map