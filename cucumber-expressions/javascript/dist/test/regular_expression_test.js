...
describe("RegularExpression", function () {
    it("documents match arguments", function () {
        var parameterRegistry = new parameter_type_registry_1.default();
        /// [capture-match-arguments]
        var expr = /I have (\d+) cukes? in my (\w+) now/;
        var expression = new regular_expression_1.default(expr, parameterRegistry);
    ...
    it("exposes regexp and source", function () {
        ...
        var expression = new regular_expression_1.default(regexp, new parameter_type_registry_1.default());
    ...
    it("does not take consider parenthesis in character class as group", function () {
        var expression = new regular_expression_1.default(/^drawings: ([A-Z_, ()]+)$/, new parameter_type_registry_1.default());
...
var match = function (regexp, text) {
    var parameterRegistry = new parameter_type_registry_1.default();
    var regularExpression = new regular_expression_1.default(regexp, parameterRegistry);
...
//# sourceMappingURL=regular_expression_test.js.map