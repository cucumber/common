...
var group_builder_1 = __importDefault(require("./group_builder"));
// @ts-ignore
...
var TreeRegexp = /** @class */ (function () {
    function TreeRegexp(regexp) {
        ...
        var stack = [new group_builder_1.default()];
        var groupStartStack = [];
        var last = null;
        var escaping = false;
        ...
        this.regexp.source.split("").forEach(function (c, n) {
            if (c === "[" && !escaping) {
                ...
                stack.push(new group_builder_1.default());
...
//# sourceMappingURL=tree_regexp.js.map