...
var parameter_type_matcher_1 = __importDefault(require("./parameter_type_matcher"));
var parameter_type_1 = __importDefault(require("./parameter_type"));
var util_1 = __importDefault(require("util"));
var combinatorial_generated_expression_factory_1 = __importDefault(require("./combinatorial_generated_expression_factory"));
    ...
    CucumberExpressionGenerator.prototype.generateExpressions = function (text) {
        ...
        var _loop_1 = function () {
            ...
            if (matchingParameterTypeMatchers.length > 0) {
                matchingParameterTypeMatchers = matchingParameterTypeMatchers.sort(parameter_type_matcher_1.default.compare);
                ...
                var bestParameterTypeMatchers = matchingParameterTypeMatchers.filter(function (m) { return parameter_type_matcher_1.default.compare(m, bestParameterTypeMatcher_1) === 0; });
                ...
                parameterTypes = parameterTypes.sort(parameter_type_1.default.compare);
        ...
        return new combinatorial_generated_expression_factory_1.default(expressionTemplate, parameterTypeCombinations).generateExpressions();
    };
    /**
     * @deprecated
     */
    ...
    CucumberExpressionGenerator.createParameterTypeMatchers2 = function (parameterType, text) {
        ...
        try {
            for (var _b = __values(parameterType.regexpStrings), _c = _b.next(); !_c.done; _c = _b.next()) {
                var regexp = _c.value;
                result.push(new parameter_type_matcher_1.default(parameterType, regexp, text));
            }
        }
...
//# sourceMappingURL=cucumber_expression_generator.js.map