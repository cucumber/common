    ...
    describe CucumberExpression do
      ...
      describe "escapes special characters" do
        ...
        it "escapes ." do
          ...
          expression = CucumberExpression.new(expr, ParameterTypeRegistry.new)
          expect(expression.match("I have 800 cukes and 3")).to eq(nil)
          arg1 = expression.match("I have 800 cukes and .")[0]
          expect(arg1.value(nil)).to eq(800)
        end
        ...
        it "escapes |" do
          ...
          expression = CucumberExpression.new(expr, ParameterTypeRegistry.new)
          expect(expression.match("I have 800 cukes and a")).to eq(nil)
          expect(expression.match("I have 800 cukes and b")).to eq(nil)
          arg1 = expression.match("I have 800 cukes and a|b")[0]
          expect(arg1.value(nil)).to eq(800)
        end
      end
